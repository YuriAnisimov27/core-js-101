...
function chainPromises(array, action) {
  return array.reduce((currentPromise, nextPromise) => {
    let currentPromiseResult;
    return currentPromise
      .then((res) => {
        currentPromiseResult = res;
        return nextPromise.then((promiseResult) => action(currentPromiseResult, promiseResult));
      })
      .catch(() => currentPromiseResult);
  });
}
